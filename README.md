...
4. Set Railway environment variables from `.env.example.prod`.
5. Deploy both services.

> If you use Railway plugins, add PostgreSQL and Redis and wire the service env vars into the backend.
